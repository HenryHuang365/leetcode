...
class Solution {
    ...
    public static void main(String[] args) {
        char[][] solution = new Solution().updateBoardDFS(new char[][] { { 'E', 'E', 'E', 'E', 'E' },
                { 'E', 'E', 'M', 'E', 'E' }, { 'E', 'E', 'E', 'E', 'E' }, { 'E', 'E', 'E', 'E', 'E' } },
                new int[] { 3, 0 });
        char[][] solution1 = new Solution().updateBoardBFS(new char[][] { { 'E', 'E', 'E', 'E', 'E' },
                { 'E', 'E', 'M', 'E', 'E' }, { 'E', 'E', 'E', 'E', 'E' }, { 'E', 'E', 'E', 'E', 'E' } },
                new int[] { 3, 0 });
        for (char[] s : solution) {
